...
danger(args) {
    ...
    onGitHub {
        message("Thank you so much for your work here @${pullRequest.user.login} 🎉 You might find a few suggestions from me for this Pull Request below 🙂")

        if (pullRequest.title.contains("WIP", false)) {
            fail("I noticed this is marked as Work In Progress, does it need to be open before it is ready? 🤔 If so, convert it to a Draft Pull Request and remove WIP from title 😉")
        }
